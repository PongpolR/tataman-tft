  ...
  const blogPosts = [
    ...
    },
    {
      ...
      body2: [
        ...
        "แต่สิ่งหนึ่งที่ผมไม่มีเมื่อเทียบกับคนที่มีฝีมือเท่ากันคือ consistency หรือความสม่ำเสมอในการเล่น บางเกมผมเล่นได้ดีมากๆ แต่บางเกมผมเล่นเหมือนคนที่อยู่ rank gold ซะอย่างงั้น!? (ไม่ได้เหยียด rank แต่อย่างใด เปรียบเทียบให้เห็นภาพว่า master player ในเกมที่เล่นไม่ดี ทรงมันจะกลายเป็น gold/plat player ได้เลย)",
